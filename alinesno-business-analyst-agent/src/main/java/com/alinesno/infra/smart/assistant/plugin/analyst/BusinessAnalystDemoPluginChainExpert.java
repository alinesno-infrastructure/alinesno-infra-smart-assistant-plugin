...
@Slf4j
@Component
public class BusinessAnalystDemoPluginChainExpert extends PlatformExpert {

    private static final String promptId = "0GSheQ31" ;
    private List<String> resultMap ;

    @LiteflowComponent(value = "BADemoPlugin_a" , name="插件测试执行节点A")
    ...
    @LiteflowComponent(value = "BADemoPlugin_b" , name="插件测试执行节点B")
    ...
    @LiteflowComponent(value = "BADemoPlugin_c" , name="插件测试执行节点C")
