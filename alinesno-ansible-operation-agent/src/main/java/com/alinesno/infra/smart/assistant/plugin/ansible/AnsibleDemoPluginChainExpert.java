...
@Slf4j
@Component
public class AnsibleDemoPluginChainExpert extends PlatformExpert {

    private static final String promptId = "0GSheQ31" ;
    private List<String> resultMap ;

    @LiteflowComponent(value = "AnsibleDemoPlugin_a" , name="插件测试执行节点A")
    ...
    @LiteflowComponent(value = "AnsibleDemoPlugin_b" , name="插件测试执行节点B")
    ...
    @LiteflowComponent(value = "AnsibleDemoPlugin_c" , name="插件测试执行节点C")
