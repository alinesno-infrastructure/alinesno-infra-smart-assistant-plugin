package com.alinesno.infra.smart.assistant.plugin.kubernetes;
...
@Slf4j
@Component
public class KubernetesDemoPluginChainExpert extends PlatformExpert {

    private static final String promptId = "0GSheQ31" ;
    private List<String> resultMap ;

    @LiteflowComponent(value = "KubernetesDemoPlugin_a" , name="插件测试执行节点A")
    ...
    @LiteflowComponent(value = "KubernetesDemoPlugin_b" , name="插件测试执行节点B")
    ...
    @LiteflowComponent(value = "KubernetesDemoPlugin_c" , name="插件测试执行节点C")
