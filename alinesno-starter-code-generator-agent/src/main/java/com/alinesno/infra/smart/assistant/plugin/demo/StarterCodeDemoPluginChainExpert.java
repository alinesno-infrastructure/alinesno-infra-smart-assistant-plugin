...
@Slf4j
@Component
public class StarterCodeDemoPluginChainExpert extends PlatformExpert {

    private static final String promptId = "0GSheQ31" ;
    private List<String> resultMap ;

    @LiteflowComponent(value = "StarterCodeDemoPlugin_a" , name="插件测试执行节点A")
    ...
    @LiteflowComponent(value = "StarterCodeDemoPlugin_b" , name="插件测试执行节点B")
    ...
    @LiteflowComponent(value = "StarterCodeDemoPlugin_c" , name="插件测试执行节点C")
