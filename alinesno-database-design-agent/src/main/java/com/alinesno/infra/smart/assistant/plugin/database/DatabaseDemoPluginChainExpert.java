...
@Slf4j
@Component
public class DatabaseDemoPluginChainExpert extends PlatformExpert {

    private static final String promptId = "0GSheQ31" ;
    private List<String> resultMap ;

    @LiteflowComponent(value = "DataDemoPlugin_a" , name="插件测试执行节点A")
    ...
    @LiteflowComponent(value = "DataDemoPlugin_b" , name="插件测试执行节点B")
    ...
    @LiteflowComponent(value = "DataDemoPlugin_c" , name="插件测试执行节点C")
